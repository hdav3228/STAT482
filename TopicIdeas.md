...
| 3 | **Modeling Mental Health Condition Prevalence from Survey Data** | Analyze survey-based mental health screening data to identify demographic and behavioral factors most strongly associated with mental health conditions (depression, bipolar disorder, etc.). Explore how symptom patterns cluster across populations — including those who never seek formal treatment — and which factors best predict condition severity. | [Mental Health Dataset](https://www.kaggle.com/datasets/imtkaggleteam/mental-health) — survey/screening questionnaire responses covering multiple mental health conditions and demographic variables. | Logistic or ordinal regression for condition classification, variable selection, symptom-based clustering (k-means or hierarchical), demographic interaction effects. Could extend with latent class analysis or prevalence comparisons across subgroups. |
