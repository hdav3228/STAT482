...
The standalone GLMM then shows that batter-level heterogeneity remains real but modest even after introducing those pitch-context covariates: the estimated ICC of \glmmICC\% suggests batter identity explains only a small share of latent whiff variation.
