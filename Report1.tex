...
In the next phase of this project, we will proceed with the model framework outlined in the introduction:
\begin{enumerate}[nosep]
    ...
    \item A \textbf{combined model} that jointly incorporates sequencing (2) and batter random intercepts (3), allowing us to assess whether the two sources of variation, pitch context          and batter heterogeneity, provide complementary explanatory power beyond what either captures alone.
\end{enumerate}
