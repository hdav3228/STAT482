...
\begin{itemize}[nosep]
    \item Release Speed (mph): Velocity of the pitch 
          at the point of release from the pitcher's hand.
    \item Induced Vertical Break (in.): Vertical movement of 
          the pitch relative to a theoretical spinless pitch.
    \item Horizontal Break (in.): Lateral movement of the 
          pitch relative to a theoretical spinless pitch.
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Exclude pitches with missing physical measurements:} Pitches with missing physical characteristics such as Release Speed are dropped, as these variables are required
        predictors in all planned models. 
